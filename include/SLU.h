 ...
 *
 */
#ifndef __SUPERLU_dzSP_DEFS /* allow multiple inclusions */
#define __SUPERLU_dzSP_DEFS
...
/// Double precision SuperLU namespace wrapper
namespace SLUD
{
  /*
...
/// We cannot wrap external C calls within a namespace as it will be discarded
#ifdef __cplusplus
extern "C" {
#endif
...
dgssvx(superlu_options_t *, SuperMatrix *, int *, int *, int *,
       ...
       SLUD::mem_usage_t *, SuperLUStat_t *, int *);
...
extern void    countnz (const int, int *, int *, int *, SLUD::GlobalLU_t *);
extern void    fixupL (const int, const int *, SLUD::GlobalLU_t *);
...
extern int     dLUMemInit (fact_t, void *, int, int, int, int, int,
			     SuperMatrix *, SuperMatrix *,
			     SLUD::GlobalLU_t *, int **, double **);
extern void    dSetRWork (int, int, double *, double **, double **);
extern void    dLUWorkFree (int *, double *, SLUD::GlobalLU_t *);
extern int     dLUMemXpand (int, int, MemType, int *, SLUD::GlobalLU_t *);

extern double  *doubleMalloc(int);
extern double  *doubleCalloc(int);
extern int     dmemory_usage(const int, const int, const int, const int);
extern int     dQuerySpace (SuperMatrix *, SuperMatrix *, SLUD::mem_usage_t *);
...
extern void    PrintPerf (SuperMatrix *, SuperMatrix *, SLUD::mem_usage_t *,
...
extern void    print_lu_col(char *, int, int, int *, SLUD::GlobalLU_t *);
...
/// Double complex SuperLU namespace wrapper
namespace SLUZ
{
  /*
   * Global data structures used in LU factorization -
...
/// We cannot wrap external C calls in a namespace as it will be discarded
#ifdef __cplusplus
extern "C" {
#endif
...
zgssvx(superlu_options_t *, SuperMatrix *, int *, int *, int *,
       ...
       void *, int, SuperMatrix *, SuperMatrix *,
       double *, double *, double *, double *,
       SLUZ::mem_usage_t *, SuperLUStat_t *, int *);
...
extern int     zcopy_to_ucol (int, int, int *, int *, int *,
                              doublecomplex *, SLUZ::GlobalLU_t *);         
extern int     zpivotL (const int, const double, int *, int *, 
                         int *, int *, int *, SLUZ::GlobalLU_t *, SuperLUStat_t*);
extern void    zpruneL (const int, const int *, const int, const int,
			  const int *, const int *, int *, SLUZ::GlobalLU_t *);
...
extern int     zLUMemInit (fact_t, void *, int, int, int, int, int,
			     SuperMatrix *, SuperMatrix *,
			     SLUZ::GlobalLU_t *, int **, doublecomplex **);
extern void    zSetRWork (int, int, doublecomplex *, doublecomplex **, doublecomplex **);
extern void    zLUWorkFree (int *, doublecomplex *, SLUZ::GlobalLU_t *);
extern int     zLUMemXpand (int, int, MemType, int *, SLUZ::GlobalLU_t *);
...
extern int     zQuerySpace (SuperMatrix *, SuperMatrix *, SLUZ::mem_usage_t *);
...
// REH: already defined abve
//extern void    PrintPerf (SuperMatrix *, SuperMatrix *, mem_usage_t *,
//			 oublecomplex, doublecomplex, doublecomplex *, doublecomplex *, char *);
