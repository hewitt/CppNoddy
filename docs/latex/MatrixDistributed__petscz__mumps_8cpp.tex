\doxysubsection{Tests/\+Matrix/\+Matrix\+Distributed\+\_\+petscz\+\_\+mumps.cpp File Reference}
\label{MatrixDistributed__petscz__mumps_8cpp}\index{Tests/Matrix/MatrixDistributed\_petscz\_mumps.cpp@{Tests/Matrix/MatrixDistributed\_petscz\_mumps.cpp}}
...
\mbox{\label{MatrixDistributed__petscz__mumps_8cpp_a0ddf1224851353fc92bfbff6f499fa97}} 
\index{MatrixDistributed\_petscz\_mumps.cpp@{MatrixDistributed\_petscz\_mumps.cpp}!main@{main}}
\index{main@{main}!MatrixDistributed\_petscz\_mumps.cpp@{MatrixDistributed\_petscz\_mumps.cpp}}
\doxyparagraph{main()}
{\footnotesize\ttfamily int main (\begin{DoxyParamCaption}\item[{int}]{argc,  }\item[{char $\ast$}]{argv[$\,$] }\end{DoxyParamCaption})}



Definition at line 17 of file Matrix\+Distributed\+\_\+petscz\+\_\+mumps.\+cpp.
...
\DoxyCodeLine{20 }
\DoxyCodeLine{21   PetscPrintf(PETSC\_COMM\_WORLD, \textcolor{stringliteral}{"\(\backslash\)n=== Vector: A distributed (complex) example =========\(\backslash\)n\(\backslash\)n"});}
\DoxyCodeLine{22 }
\DoxyCodeLine{23   std::size\_t Nx(801);}
\DoxyCodeLine{24   std::size\_t Ny(801);}
...
\DoxyCodeLine{30   DistributedMatrix<D\_complex> matA( N, N, 5, 4 );}
\DoxyCodeLine{31   DistributedVector<D\_complex> vecB( N );}
\DoxyCodeLine{32 }
...
\DoxyCodeLine{43       DenseVector<D\_complex> value;}
...
\DoxyCodeLine{70 }
\DoxyCodeLine{71   DistributedLinearSystem<D\_complex> system( \&matA, \&vecB );}
